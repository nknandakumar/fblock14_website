...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Your product or service, our audience. Sponsored posts, story features, and paid promotions that reach real buyers in Shivamogga and beyond.",
        ...
        <div className="flex flex-col items-center text-center mb-16 gap-4">
          ...
          <ScrollReveal delay={0.1}>
            <h2 className="text-3xl md:text-4xl font-extrabold uppercase tracking-tight text-white font-sans">
              Three Ways Brands Work With <span className="text-accent">F_BLOCK_14</span>
            </h2>
          </ScrollReveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, idx) => (
            <ScrollReveal
              ...
              className="h-full"
            >
              <div className="bg-card-dark border-t-4 border-t-accent border-x border-b border-white/5 p-8 rounded-3xl flex flex-col justify-between min-h-[320px] transition-all duration-300 relative group overflow-hidden shadow-lg shadow-black/30 hover:-translate-y-2 hover:border-accent/30">
